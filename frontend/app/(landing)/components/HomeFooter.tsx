      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 font-light relative">
          ...
          <div className="my-4 md:my-0 flex items-center gap-3">
            <a href="https://wa.me/5511950201275" target="_blank" className="p-2.5 rounded-full bg-green-600/20 border border-green-500/30 text-green-400 hover:bg-green-600/30 hover:text-green-300 transition-all active:scale-90 min-h-[44px] min-w-[44px] flex items-center justify-center" title="WhatsApp">
            ...
            <a href="https://instagram.com/ottopinturas" target="_blank" className="p-2.5 rounded-full bg-pink-600/20 border border-pink-500/30 text-pink-400 hover:bg-pink-600/30 hover:text-pink-300 transition-all active:scale-90 min-h-[44px] min-w-[44px] flex items-center justify-center" title="Instagram">
